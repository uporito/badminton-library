...
- **CV (Phase 4):** Separate Python FastAPI service (`cv_service/`). PyTorch, Ultralytics (YOLO), TrackNetV3, PySceneDetect, OpenCV. Communicates with Next.js via HTTP. Requires `CV_SERVICE_URL` env var (default `http://127.0.0.1:8100`).
